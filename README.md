...
![Пример изображения c локалки](/jenny.jpg)  
Эта картинка должна быть залита в папку public. Она будет работать на сайте, но в гите не хочет)  
![Пример изображения](https://i.ytimg.com/vi/lsgS74iJYLc/hq720.jpg)  
Эта картинка взята с интернета, просто ссылкой.
---
